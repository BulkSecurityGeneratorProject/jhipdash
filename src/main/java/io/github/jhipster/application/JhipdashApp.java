...
public class JhipdashApp {

    private static final Logger log = LoggerFactory.getLogger(JhipdashApp.class);

    private final Environment env;

    public JhipdashApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipdash.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipdashApp.class);
